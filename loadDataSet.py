...
def arraydec2Z(D,tok =None):
    ...
    for i in range(r):
        ...
        #             continue
        #         else:
        #             ZOrderArray[i,validx] = (Listi[loopIter])
        #             validx += 1

        ZOrderArray[i,:] = (br)

        # for j in range(bitcodlen):
        #     ZOrderArray[i,j] = B
        # ordinaryOrder
        # bbr = []
        # for rowb in BinaryrowList:
        #     for bit in rowb:
        #         bbr.append(bit)
        # ZOrderArray.append(bbr)
        #
        # print(BinaryrowList)
        # if tok == None:
        #     ZOrderArray.append(binaryRow2Zencode(BinaryrowList))
        # else:
        #     ZOrderArray.append(binaryRow2TokZencode(BinaryrowList,tok))
    # ZOrderArray = np.array(ZOrderArray)
    return ZOrderArray
